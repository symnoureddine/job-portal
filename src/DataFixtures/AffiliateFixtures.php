...
class AffiliateFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager) : void
    {
        ...
        $affiliateSensioLabs->addCategory($this->getReference('category-programming'));
        ...
        $affiliateKNPLabs->addCategory($this->getReference('category-programming'));
        $affiliateKNPLabs->addCategory($this->getReference('category-design'));
